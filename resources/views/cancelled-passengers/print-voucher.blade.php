...
<head>
    ...
    <title>Refund Voucher (passenger cancellation) - BM Umrah</title>
    ...
    <div class="voucher-wrap">
        ...
        <div class="info-grid">
            ...
            <div class="info-row">
                ...
                <span class="value">{{ $cp->passenger?->booking?->invoice_id ?? '—' }}</span>
            </div>
            <div class="info-row">
                <span class="label">Passenger:</span>
                <span class="value">{{ $cp->passenger?->full_name ?? $cp->passenger?->first_name ?? '—' }}</span>
            </div>
        </div>
        ...
        <div class="info-grid" style="margin-bottom: 18px;">
            ...
            <div class="info-row">
                ...
                <span class="value">{{ $cp->created_at?->format('d-M-Y') ?? '—' }}</span>
            </div>
            <div class="info-row">
        ...
        <div class="info-grid" style="margin-bottom: 18px;">
            <div class="info-row">
                ...
                <span class="value">{{ ucfirst($cp->refundPayment?->payment_method?->value ?? '—') }}</span>
            </div>
            <div class="info-row">
