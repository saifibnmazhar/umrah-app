...
<div class="max-w-2xl mx-auto">
    ...
    <h1 class="text-2xl font-bold text-slate-800 mb-6">Add Visa Agent</h1>

    <form method="POST" action="{{ route('visa-agents.store') }}" class="bg-white rounded-lg shadow-sm border border-slate-200 p-6 space-y-5">
        @csrf
