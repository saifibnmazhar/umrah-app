        ...
        <form @submit.prevent="savePassenger()">
            ...
            <div class="mb-4" x-show="!isDoubleTicket">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select id="passengerFlightDateRange" x-model="passengerData.flight_date_range" required class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-400 focus:border-slate-400 outline-none bg-white">
            ...
            <div class="mb-4" x-show="isDoubleTicket">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-1">Flight Date Range *</label>
                        <select id="passengerFlightDateRangeDouble" x-model="passengerData.flight_date_range" @change="onFlightDateRangeChange()" required class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-400 focus:border-slate-400 outline-none bg-white">
                            <option value="">Select Date Range</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="mb-4">
                ...
                <div class="border-2 border-dashed border-slate-300 rounded-lg p-4 text-center hover:border-slate-400 transition cursor-pointer" onclick="document.getElementById('passenger_doc_input').click()">
                    <input type="file" id="passenger_doc_input" class="hidden" accept=".pdf,.jpg,.jpeg,.png" multiple @change="handlePassengerDocUpload($event.target)">
