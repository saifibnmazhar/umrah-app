...
<div class="max-w-3xl mx-auto">
    ...
    <h1 class="text-2xl font-bold text-slate-800 mb-6">Edit Voucher</h1>

    <form method="POST" action="{{ route('vouchers.update', $voucher->id) }}" class="bg-white rounded-lg shadow-sm border border-slate-200 p-6 space-y-5">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                ...
                <input 
                    ...
                    name="voucher_id" 
                    id="voucher_id" 
                    value="{{ old('voucher_id', $voucher->voucher_id) }}"
                    maxlength="255"
            ...
            <div>
                ...
                >
                    ...
                    @foreach($transactionTypes as $type)
                        <option value="{{ $type->id }}" {{ old('transaction_type_id', $voucher->transaction_type_id) == $type->id ? 'selected' : '' }}>
            ...
            <div>
                ...
                >
                    ...
                    @foreach($bookings as $booking)
                        <option value="{{ $booking->id }}" {{ old('booking_id', $voucher->booking_id) == $booking->id ? 'selected' : '' }}>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div>
                ...
                <input 
                    ...
                    name="payment_date" 
                    id="payment_date" 
                    value="{{ old('payment_date', $voucher->payment_date) }}"
                    required
            ...
            <div>
                ...
                >
                    ...
                    <option value="bank" {{ old('payment_method', $voucher->payment_method) == 'bank' ? 'selected' : '' }}>Bank</option>
                </select>
            ...
            <div>
                ...
                >
                    ...
                    @foreach($banks as $bank)
                        <option value="{{ $bank->id }}" {{ old('bank_id', $voucher->bank_id) == $bank->id ? 'selected' : '' }}>
                            {{ $bank->name }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <input 
                    ...
                    name="bdt_amount" 
                    id="bdt_amount" 
                    value="{{ old('bdt_amount', $voucher->bdt_amount) }}"
                    step="0.01"
                    min="0"
                    required
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                ...
                >
                    ...
                    @foreach($currencyRates as $rate)
                        <option value="{{ $rate->id }}" {{ old('currency_rate_id', $voucher->currency_rate_id) == $rate->id ? 'selected' : '' }}>
            ...
            <div>
                ...
                <input 
                    ...
                    name="transaction_id" 
                    id="transaction_id" 
                    value="{{ old('transaction_id', $voucher->transaction_id) }}"
                    maxlength="255"
            ...
            <div>
                ...
                >
                    ...
                    @foreach($ticketAgents as $agent)
                        <option value="{{ $agent->id }}" {{ old('ticket_agent_id', $voucher->ticket_agent_id) == $agent->id ? 'selected' : '' }}>
                            {{ $agent->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                >
                    ...
                    @foreach($visaAgents as $agent)
                        <option value="{{ $agent->id }}" {{ old('visa_agent_id', $voucher->visa_agent_id) == $agent->id ? 'selected' : '' }}>
                            {{ $agent->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                >
                    ...
                    @foreach($commissionAgents as $agent)
                        <option value="{{ $agent->id }}" {{ old('commission_agent_id', $voucher->commission_agent_id) == $agent->id ? 'selected' : '' }}>
                            {{ $agent->name }}
                        </option>
                    @endforeach
                </select>
