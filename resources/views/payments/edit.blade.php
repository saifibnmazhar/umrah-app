        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <input 
                    ...
                    name="bdt_amount" 
                    id="bdt_amount" 
                    value="{{ old('bdt_amount', $payment->bdt_amount) }}"
                    step="0.01"
                    min="0"
                    required
            ...
            <div>
                ...
                >
                    ...
                    @foreach($currencyRates as $rate)
                        <option value="{{ $rate->id }}" {{ old('currency_rate_id', $payment->currency_rate_id) == $rate->id ? 'selected' : '' }}>
            ...
            <div>
                ...
                >
                    ...
                    @foreach($ticketAgents as $agent)
                        <option value="{{ $agent->id }}" {{ old('ticket_agent_id', $payment->ticket_agent_id) == $agent->id ? 'selected' : '' }}>
                            {{ $agent->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                >
                    ...
                    @foreach($visaAgents as $agent)
                        <option value="{{ $agent->id }}" {{ old('visa_agent_id', $payment->visa_agent_id) == $agent->id ? 'selected' : '' }}>
                            {{ $agent->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                >
                    ...
                    @foreach($commissionAgents as $agent)
                        <option value="{{ $agent->id }}" {{ old('commission_agent_id', $payment->commission_agent_id) == $agent->id ? 'selected' : '' }}>
                            {{ $agent->name }}
                        </option>
                    @endforeach
                </select>
