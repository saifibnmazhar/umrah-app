...
<div class="max-w-2xl mx-auto">
    ...
    <h1 class="text-2xl font-bold text-slate-800 mb-6">Add Customer</h1>

    <form method="POST" action="{{ route('customers.store') }}" class="bg-white rounded-lg shadow-sm border border-slate-200 p-6 space-y-5">
        @csrf
        ...
        <div>
            ...
            <select name="iqama_type" id="iqama_type" class="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent @error('iqama_type') border-red-500 @enderror">
                ...
                <option value="self" {{ old('iqama_type') == 'self' ? 'selected' : '' }}>Self</option>
        ...
        <div>
            ...
            <input type="text" name="passport_no" id="passport_no" value="{{ old('passport_no') }}" class="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent @error('passport_no') border-red-500 @enderror">
            @error('passport_no')
                <span class="text-sm text-red-600 mt-1 block">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="iqama_no" id="iqama_no" value="{{ old('iqama_no') }}" class="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent @error('iqama_no') border-red-500 @enderror">
            @error('iqama_no')
                <span class="text-sm text-red-600 mt-1 block">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="mobile_no" id="mobile_no" value="{{ old('mobile_no') }}" class="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent @error('mobile_no') border-red-500 @enderror">
            @error('mobile_no')
                <span class="text-sm text-red-600 mt-1 block">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="ref_iqama_no" id="ref_iqama_no" value="{{ old('ref_iqama_no') }}" class="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent @error('ref_iqama_no') border-red-500 @enderror">
            @error('ref_iqama_no')
                <span class="text-sm text-red-600 mt-1 block">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="ref_mobile_no" id="ref_mobile_no" value="{{ old('ref_mobile_no') }}" class="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent @error('ref_mobile_no') border-red-500 @enderror">
            @error('ref_mobile_no')
                <span class="text-sm text-red-600 mt-1 block">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="ref_iqama_doc" id="ref_iqama_doc" value="{{ old('ref_iqama_doc') }}" class="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent @error('ref_iqama_doc') border-red-500 @enderror">
            @error('ref_iqama_doc')
                <span class="text-sm text-red-600 mt-1 block">{{ $message }}</span>
            @enderror
        </div>
