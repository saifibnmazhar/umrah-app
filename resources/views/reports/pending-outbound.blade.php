            ...
            <table class="w-full min-w-[1200px] table-fixed">
                <thead>
                    <tr class="table-header">
                        ...
                        <th class="w-32 px-2 py-3 text-xs font-bold text-gray-700 text-center border-r border-gray-300">Pending Tkt Status</th>
                ...
                <tbody id="reportTableBody">
                    ...
                    <template x-if="!loading && data.length === 0">
                        <tr>
                            <td colspan="9" class="px-3 py-8 text-center text-slate-500">No pending outbound ticket records found</td>
                        </tr>
                    </template>
                        ...
                        <tr class="table-row-ticket">
                            ...
                            <td class="px-2 py-2 text-xs text-center border-r border-gray-200">
                                <span class="status-badge"
                                      :class="{
                                          'status-not-arrived': row.status === 'pending' && !row.flight_date,
                                          'status-pending': row.status === 'pending' && row.flight_date,
                                          'status-issued': row.status === 'issued' || row.status === 're-issued'
                                      }"
                                      x-text="{
                                          pending: 'Pending',
                                          issued: 'Issued',
        ...
        <div class="flex flex-wrap gap-6">
            <div class="footer-box rounded-lg overflow-hidden min-w-[320px]">
                <div class="footer-box-header px-4 py-2">
                    <span class="text-sm font-bold text-gray-700">Pending Outbound Ticket Summary</span>
                </div>
                <div class="p-4">
