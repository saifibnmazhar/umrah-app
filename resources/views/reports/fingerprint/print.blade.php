...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .print-info { display: flex; justify-content: space-between; font-size: 11px; margin-bottom: 8px; color: #555; }
        .filters-summary { font-size: 11px; margin-bottom: 10px; padding: 6px; border: 1px solid #ccc; background: #f9f9f9; }
        .filters-summary strong { font-size: 11px; }
