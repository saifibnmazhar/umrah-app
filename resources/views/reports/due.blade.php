...
<div class="max-w-3xl mx-auto" x-data="{ date_from: '', date_to: '', agent: '' }">
    <h1 class="text-2xl font-bold text-slate-800 mb-6">Due Report</h1>
        ...
        <table class="min-w-full bg-white border border-slate-200 rounded-lg shadow-sm">
            <thead class="bg-slate-50">
                <tr>
                    ...
                    <th class="px-3 py-2 text-left text-xs font-medium text-slate-600 uppercase">Paid</th>
            ...
            <tbody class="divide-y divide-slate-200">
                <tr>
                    ...
                    <td class="px-3 py-2 text-sm text-slate-700">{{ $total_cost ?? '70000' }}</td>
                    <td class="px-3 py-2 text-sm text-slate-700">{{ $paid ?? '50000' }}</td>
                    <td class="px-3 py-2 text-sm text-red-600">{{ $due ?? '20000' }}</td>
                </tr>
            </tbody>
        </table>
    </div>
