...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden mb-6">
        <form method="GET" action="{{ route('ticket-fares.index') }}" id="filter-form" class="p-4 flex flex-wrap gap-4 items-end">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var container = document.getElementById('ticket-fare-table-container');
    ...
    function fetchFilteredResults() {
        ...
        fetch(url, {
            ...
            var newContent = doc.getElementById('ticket-fare-table-container');
            if (newContent) {
    ...
    form.querySelectorAll('select').forEach(function (el) {
        el.addEventListener('change', fetchFilteredResults);
    });
