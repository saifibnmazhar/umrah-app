                ...
                <table class="w-full text-sm">
                    <thead class="bg-slate-50 text-slate-600">
                        <tr>
                            ...
                            <th class="px-3 py-2 text-right font-medium">Reissue Cost</th>
                    ...
                    <tbody class="divide-y divide-slate-200">
                        <tr>
                            <td colspan="8" class="px-3 py-4 text-center text-slate-500">No re-issue records</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table class="w-full text-sm">
                    <thead class="bg-slate-50 text-slate-600">
                        <tr>
                            ...
                            <th class="px-3 py-2 text-left font-medium">PNR</th>
                            <th class="px-3 py-2 text-left font-medium">Agent</th>
                            <th class="px-3 py-2 text-right font-medium">Ticket Cost</th>
                            <th class="px-3 py-2 text-left font-medium">Status</th>
                            <th class="px-3 py-2 text-left font-medium">Action</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-200">
                        <tr>
                            <td colspan="8" class="px-3 py-4 text-center text-slate-500">No additional ticket records</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div id="content-refund" class="tab-content hidden bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-200">
                        <tr>
                            <td colspan="8" class="px-3 py-4 text-center text-slate-500">No refund records</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
@media print {
    ...
    .tab-content:not(.block) { display: none !important; }
}
</style>
