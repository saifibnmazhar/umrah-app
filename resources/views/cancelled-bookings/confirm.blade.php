            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-1">Default: {{ $cancelledBooking->refund_amount }} SAR (Total Paid &minus; Total Cost &minus; Service Charge + Total Passenger Refundable)</p>
                    </div>
