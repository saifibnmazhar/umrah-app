...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('booking_update_logs', function (Blueprint $table) {
            if (Schema::hasColumn('booking_update_logs', 'booking_id')) {
        ...
        if (! Schema::hasColumn('booking_update_logs', 'booking_invoice_id')) {
            Schema::table('booking_update_logs', function (Blueprint $table) {
        ...
        Schema::table('passenger_update_logs', function (Blueprint $table) {
            if (Schema::hasColumn('passenger_update_logs', 'passenger_id')) {
        ...
        if (! Schema::hasColumn('passenger_update_logs', 'passport_no')) {
            Schema::table('passenger_update_logs', function (Blueprint $table) {
