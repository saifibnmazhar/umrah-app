...
class VisaAgentCostController extends Controller
{
    ...
    public function update(Request $request, VisaAgentCost $visaAgentCost)
    {
        ...
        try {
            ...
            return redirect()->route('visa-agent-costs.index')->with('success', 'Visa agent cost updated successfully.');
        } catch (\Exception $e) {
    ...
    public function destroy(VisaAgentCost $visaAgentCost)
    {
        try {
            ...
            return redirect()->route('visa-agent-costs.index')->with('success', 'Visa agent cost deleted successfully.');
        } catch (\Exception $e) {
